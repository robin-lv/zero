...
func NewServer(c RpcServerConf, register internal.RegisterFn, serverOptions ...internal.ServerOption) (*RpcServer, error) {
	var err error
	...
	serverOptions = append(serverOptions, internal.WithRpcHealth(c.Health))
